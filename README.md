...
│ ├── guards/ # Guards для авторизации (JwtAuthGuard и т.п.)
...
│ ├── decorators/ # Пользовательские декораторы (например, @GetUser)
│ ├── guards/ # Guards для защиты задач, если требуется
...
├── prisma/ # Prisma сервис (PrismaService)
